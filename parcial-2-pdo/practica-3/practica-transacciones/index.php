    ...
    if ($nombre === "" || $apellido === "" || $correo === "") {
        ...
        try {
            ...
            if ($simularError) {
                ...
                //Alternativa: usar una tabla inexistentes para fallar
    ...
    <div class="card">
        <form method="POST">
            <div class="row">
                <div>
                    <label>Nombre</label>
                    <input type="text" name="nombre" maxlength="15" value="<?= htmlspecialchars($_POST['nombre'] ?? 'Michelle') ?>">
                </div>
                <div>
                    <label>Apellido</label>
                    <input type="text" name="apellido" maxlength="10" value="<?= htmlspecialchars($_POST['apellido'] ?? 'Quintero Bonilla') ?>">
                </div>
                <div>
                    <label>Correo</label>
                    <input type="email" name="correo" maxlength="50" value="<?= htmlspecialchars($_POST['correo'] ?? 'qbmichelle175@gmail.com') ?>">
                </div>
            </div>
